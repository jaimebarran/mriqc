...
# from mriqc.reports.reportlet import Reportlet


# Add a new figures spec
try:
    add_config_paths(figures=pkgrf("mriqc.reports", "data/nipreps.json"))
...
class Report:
    ...
    def __init__(
        ...
        **bids_filters,
        ...
        bootstrap_file = Path(bootstrap_file or pkgrf("mriqc.reports", "data/default.yml"))
        ...
        self.template_path = (
            ...
            else Path(pkgrf("mriqc.reports", "data/report.tpl")).absolute()
        )
    ...
    def index(self, config):
        ...
        _indexer = BIDSLayoutIndexer(
            config_filename=pkgrf("mriqc.reports", "data/nipreps.json"),
    ...
    def process_plugins(self, config, metadata=None):
        ...
        for plugin in (plugins or []):
            ...
            plugin_meta.update((metadata or {}).get(plugin["type"], {})) # TODO: catch metadata properly
